...
- If coherence_score < 0.7 OR feasibility_score < 0.7: requires_refinement = true
...
- validation_passed = true only if coherence_score >= 0.7 AND feasibility_score >= 0.7 AND no critical issues
