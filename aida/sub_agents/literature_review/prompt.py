...
D. Excluded Sources (STRICT):
   - DO NOT use Wikipedia, Investopedia, or similar general encyclopedias.
   - DO NOT use blogs, personal websites, or non-academic news articles.
   - DO NOT use student essays, course notes, or unverifiable PDFs.
   - ONLY use peer-reviewed papers, academic journals, conference proceedings, and reputable technical reports.
